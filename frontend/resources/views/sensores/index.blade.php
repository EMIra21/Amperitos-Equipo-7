            ...
            <table class="min-w-full divide-y divide-violet-700">
                <thead>
                    <tr class="bg-gray-900">
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-purple-400 uppercase tracking-wider space-font"><i class="fas fa-compress-arrows-alt mr-2"></i>Presión</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-purple-400 uppercase tracking-wider space-font"><i class="fas fa-wind mr-2"></i>Gas</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-purple-400 uppercase tracking-wider space-font"><i class="fas fa-smog mr-2"></i>CO</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-purple-400 uppercase tracking-wider space-font"><i class="fas fa-atom mr-2"></i>H2</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-purple-400 uppercase tracking-wider space-font"><i class="fas fa-flask mr-2"></i>CH4</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-purple-400 uppercase tracking-wider space-font"><i class="fas fa-vial mr-2"></i>NH3</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-purple-400 uppercase tracking-wider space-font"><i class="fas fa-flask-vial mr-2"></i>EtOH</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-violet-700">
                    @foreach($datos['datos'] as $dato)
                        <tr class="hover:bg-gray-700 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-purple-300">{{ number_format($dato['presion'], 2) }} hPa</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-purple-300">{{ number_format($dato['gas'], 2) }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-purple-300">{{ number_format($dato['co'], 2) }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-purple-300">{{ number_format($dato['h2'], 2) }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-purple-300">{{ number_format($dato['ch4'], 2) }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-purple-300">{{ number_format($dato['nh3'], 2) }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-purple-300">{{ number_format($dato['etoh'], 2) }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
